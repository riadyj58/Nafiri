...
class Rivax_Post_Elastic_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Post Elastic', 'kayleen');
    }
    ...
    protected function register_post_controls(){
        ...
        $this->add_control(
            'show_image',
            [
                'label'   => esc_html__( 'Show Image', 'kayleen' ),
		...
		$this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::SWITCHER,
                'selectors' => [
                    '{{WRAPPER}} .post-wrapper .image-wrapper:hover, {{WRAPPER}} .post-wrapper .image-wrapper:hover img' => 'transform: none;',
                ],
				'separator' => 'before',
            ]
        );
