<?php
/**
 * Template part for displaying single post Standard hero content - Layout 12
 */
if ( ! defined( 'ABSPATH' ) ) { exit; } // Exit if accessed directly

$post_layout_meta = rivax_get_option('single-format-standard-layout-12-meta');
$meta_args = array(
...
?>
<div class="single-hero-layout-12">
    <div class="container">
        <div class="row">
            <div class="col-12">
