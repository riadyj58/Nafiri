...
$position_to_meta = rivax_get_option('single-format-standard-layout-1-img-position'); // before / after

$cls = ' ' . $position_to_meta . '-meta';
$cls .= (rivax_get_option('single-format-standard-layout-1-radius'))? ' radius' : '';
$cls .= (rivax_get_option('single-format-standard-layout-1-shadow'))? ' shadow' : '';

$post_layout_meta = rivax_get_option('single-format-standard-layout-1-meta');
$meta_args = array(
...
echo '<div class="single-hero-layout-1">';
...
?>
    ...
    <div class="image-container<?php echo esc_html($cls); ?>">
        <?php
        if(rivax_get_option('single-format-standard-layout-1-full-img'))
