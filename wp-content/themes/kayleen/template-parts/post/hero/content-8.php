...
$cls = (rivax_get_option('single-format-standard-layout-8-radius'))? ' radius' : '';
$cls .= (rivax_get_option('single-format-standard-layout-8-shadow'))? ' shadow' : '';

$post_layout_meta = rivax_get_option('single-format-standard-layout-8-meta');
$meta_args = array(
