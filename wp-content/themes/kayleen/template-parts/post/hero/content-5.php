<?php
/**
 * Template part for displaying single post Standard hero content - Layout 5
 */
if ( ! defined( 'ABSPATH' ) ) { exit; } // Exit if accessed directly

$cls = (rivax_get_option('single-format-standard-layout-5-radius'))? ' radius' : '';
$cls .= (rivax_get_option('single-format-standard-layout-5-shadow'))? ' shadow' : '';

$post_layout_meta = rivax_get_option('single-format-standard-layout-5-meta');
$meta_args = array(
...
<div class="single-hero-layout-5">
    <div class="container">
    <div class="row align-items-center">
        ...
        <div class="col-md-8">
            <div class="image-container<?php echo esc_html($cls); ?>">
                <?php
                if(rivax_get_option('single-format-standard-layout-5-full-img'))
