<?php
/**
 * Template part for displaying single post Standard hero content - Layout 21
 */
if ( ! defined( 'ABSPATH' ) ) { exit; } // Exit if accessed directly

$cls = (rivax_get_option('single-format-standard-layout-21-radius'))? ' radius' : '';
$cls .= (rivax_get_option('single-format-standard-layout-21-shadow'))? ' shadow' : '';
$cls .= (rivax_get_option('single-format-standard-layout-21-title-bg'))? ' title-bg' : '';

$post_layout_meta = rivax_get_option('single-format-standard-layout-21-meta');
$meta_args = array(
...
?>
<div class="single-hero-layout-21">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="single-hero-layout-21-container<?php echo esc_html($cls); ?>" style="background-image: url(<?php echo esc_url(get_the_post_thumbnail_url(NULL, 'rivax-large')); ?>);">
